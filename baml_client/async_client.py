...
class BamlAsyncClient:
    ...
    async def GenerateHealthSuggestion(
        self,
        context: types.HealthAgentContext,
        baml_options: BamlCallOptions = {},
    ) -> types.AgentSuggestion:
        # Check if on_tick is provided
        if "on_tick" in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.GenerateHealthSuggestion(
                context=context, baml_options=baml_options
            )
            ...
            result = await self.__options.merge_options(
                ...
                function_name="GenerateHealthSuggestion",
                args={
                    "context": context,
                },
            )
...
class BamlStreamClient:
    ...
    def GenerateHealthSuggestion(
        self,
        context: types.HealthAgentContext,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.AgentSuggestion, types.AgentSuggestion]:
        ...
        return baml_py.BamlStream[stream_types.AgentSuggestion, types.AgentSuggestion](
            result,
            lambda x: typing.cast(
                stream_types.AgentSuggestion,
